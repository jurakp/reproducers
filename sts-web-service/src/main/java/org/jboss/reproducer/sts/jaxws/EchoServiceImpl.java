 ...
 *
 */
@WebService(targetNamespace = "http://www.example.org/sts/", portName = "EchoServicePort", serviceName = "EchoService", name = "EchoService", wsdlLocation = "WEB-INF/echo.wsdl", endpointInterface = "org.jboss.reproducer.sts.jaxws.generated.EchoService")
@EndpointProperties(value = {
        ...
        // "org.jboss.reproducer.sts.jaxws.ServerPasswordCallbackHandler")
})
@InInterceptors(classes = { LoggingInInterceptor.class, SamlSecureAnnotationsInterceptor.class})
